...
@section('title', 'Storage Lantai')

@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Storage Lantai</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-end">
                            <a class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addLantai">Add Lantai</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped align-middle">
                                ...
                                <tbody>
                                @foreach($storageLantai as $lantai)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $lantai->storageArea->name }}</td>
                                        <td>{{ $lantai->storageRak->name }}</td>
                                        <td>{{ $lantai->name }}</td>
                                        <td>
