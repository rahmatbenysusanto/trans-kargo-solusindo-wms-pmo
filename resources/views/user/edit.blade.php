                    ...
                    <form action="{{ route('user.update') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 mb-3">
                                ...
                                <input type="email" class="form-control" value="{{ $user->email }}" name="email" placeholder="user@mail.com ..." required>
                            </div>
                            <div class="col-4 mb-3">
                                <label class="form-label">No HP</label>
                                <input type="number" class="form-control" value="{{ $user->no_hp }}" name="no_hp" placeholder="089 ..." required>
                            </div>
                            <div class="col-4 mb-3">
                                <label class="form-label">Password</label>
                                <input type="text" class="form-control" value="********" name="password" placeholder="Password ..." required>
                            </div>
                            <div class="col-4 mb-3">
