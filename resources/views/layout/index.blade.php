                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            ...
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Rahmat Beny</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <h6 class="dropdown-header">Welcome Rahmat Beny</h6>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <!-- Inbound -->
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ in_array($title, ['Purchase Order', 'Put Away']) ? 'active' : '' }}" href="#inbound" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="inbound">
                            ...
                            <div class="collapse menu-dropdown {{ in_array($title, ['Purchase Order', 'Put Away']) ? 'show' : '' }}" id="inbound">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('inbound.putAway.index') }}" class="nav-link {{ $title == 'Put Away' ? 'active' : '' }}" data-key="t-analytics">
