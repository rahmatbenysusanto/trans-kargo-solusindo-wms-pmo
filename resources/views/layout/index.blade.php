            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <!-- Inbound -->
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ in_array($title, ['Purchase Order', 'Put Away']) ? 'active' : '' }}"
                                href="#inbound" data-bs-toggle="collapse" role="button" aria-expanded="false"
                                ...
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('inbound.receiving.index') }}"
                                            class="nav-link {{ $title == 'Purchase Order' ? 'active' : '' }}"
                                            data-key="t-analytics">
                                            <i class="mdi mdi-file-document-edit-outline me-2"></i> Receiving
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('inbound.putAway.index') }}"
                                            class="nav-link {{ $title == 'Put Away' ? 'active' : '' }}"
                                            data-key="t-analytics">
                        ...
                        <!-- Inventory -->
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ in_array($title, ['Inventory List', 'Stock Movement', 'Cycle Count']) ? 'active' : '' }}"
                                href="#inventory" data-bs-toggle="collapse" role="button" aria-expanded="false"
                                aria-controls="inventory">
                                <i class="mdi mdi-warehouse"></i>
                                <span data-key="t-widgets">Inventory</span>
                            </a>
                            <div class="collapse menu-dropdown {{ in_array($title, ['Inventory List', 'Stock Movement', 'Cycle Count']) ? 'show' : '' }}"
                                id="inventory">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('inbound.inventory.index') }}"
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('inventory.stockMovement.index') }}"
                                            class="nav-link {{ $title == 'Stock Movement' ? 'active' : '' }}"
                                            data-key="t-analytics">
                                            <i class="mdi mdi-arrow-decision-auto me-2"></i> Stock Movement
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('inventory.cycleCount') }}"
                                            class="nav-link {{ $title == 'Cycle Count' ? 'active' : '' }}"
                                            data-key="t-analytics">
                                            <i class="mdi mdi-clipboard-check-outline me-2"></i> Cycle Count
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <!-- Return -->
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ $title == 'Return' ? 'active' : '' }}"
                        ...
                        <!-- Storage -->
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ in_array($title, ['Area', 'Rak', 'Lantai', 'Bin']) ? 'active' : '' }}"
                                href="#storage" data-bs-toggle="collapse" role="button" aria-expanded="false"
                                ...
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('storage.area') }}"
                                            class="nav-link {{ $title == 'Area' ? 'active' : '' }}"
                                            data-key="t-analytics">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('storage.rak') }}"
                                            class="nav-link {{ $title == 'Rak' ? 'active' : '' }}"
                                            data-key="t-analytics">
                                            <i class="mdi mdi-view-column me-2"></i> Rak
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('storage.lantai') }}"
                                            class="nav-link {{ $title == 'Lantai' ? 'active' : '' }}"
                                            data-key="t-analytics">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('storage.bin') }}"
                                            class="nav-link {{ $title == 'Bin' ? 'active' : '' }}"
                                            data-key="t-analytics">
