                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown {{ in_array($title, ['Inventory List', 'Inventory History', 'Storage Inventory', 'Storage Inventory Detail', 'Stock Movement', 'Cycle Count']) ? 'show' : '' }}"
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('inventory.storageInventory.index') }}"
                                            class="nav-link {{ in_array($title, ['Storage Inventory', 'Storage Inventory Detail']) ? 'active' : '' }}"
                                            data-key="t-analytics">
                                            <i class="mdi mdi-archive-outline me-2"></i> Storage Inventory
                                        </a>
                                    </li>
                                    <li class="nav-item">
